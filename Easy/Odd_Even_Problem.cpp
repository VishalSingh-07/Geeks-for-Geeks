...
// space -> O(1) we are using only maximum 26 character to store in the hashmap which is constant
class Solution {
  public:
...
// Question link -- https://www.geeksforgeeks.org/problems/help-nobita0532/1