  ...
  public:
    int minRow(int n, int m, vector<vector<int>> a) {
        ...
        for(int i=0;i<n;i++){
            ...
            if(count<minimumNumberOnes){
                minimumNumberOnes=count;
                minimumRow=i+1;
            }
        }
        return minimumRow;
...
// Question lin -- https://www.geeksforgeeks.org/problems/row-with-minimum-number-of-1s5430/1